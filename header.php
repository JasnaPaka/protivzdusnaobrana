...
<head>
  ...
  <link rel="icon" href="<?php bloginfo('template_url') ?>-child-protileteckaobrana/favicon.ico" type="image/x-icon" />
	...
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_url'); ?>" media="screen, print" />
        <link rel="stylesheet"  type="text/css" href="<?php bloginfo('template_url') ?>-child-protileteckaobrana/print.css" media="print" />
      ...
      <div id="blacked">
        <div class="inner">       
          ...
          <div id="header-top-right">
            ...
            <div id="socials">
              <a id="social_rss" href="<?php printf('%s/feed', get_bloginfo('url')); ?>"></a><a id="social_fb" target="_blank" href="https://www.facebook.com/groups/protivzdusnaobranaplzne/"></a><a class="showpopup" id="newsletter" href="#"></a>
